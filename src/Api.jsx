    ...
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px", background: "#f8f9fa" }}>
      ...
      <div style={{ background: "#1a1a2e", padding: "20px", color: "#fff", borderRadius: "8px", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
        ...
        <p style={{ margin: "5px 0 0", fontSize: "14px" }}>
          <span style={{ color: "#f7941d", fontWeight: "bold" }}>HOME</span> &gt; API SERVICES
        </p>
      </div>
      ...
      <div style={{ display: "flex", marginTop: "20px", gap: "20px" }}>
        ...
        <div style={{ flex: "3", paddingRight: "20px" }}>
          <img src="https://i0.wp.com/packetstream.io/wp-content/uploads/2020/07/4-1.jpg?fit=800%2C599&ssl=1" 
               alt="API Services" 
               style={{ width: "90%", borderRadius: "8px", boxShadow: "0px 4px 8px rgba(0,0,0,0.1)" }} 
          />
          <h2 style={{ marginTop: "20px", color: "#1a1a2e" }}>API Services</h2>
          <p style={{ color: "#555", lineHeight: "1.6" }}>
            At GK Technology, we build robust, scalable, and secure APIs that power seamless integrations and enable businesses to enhance their digital ecosystems.
          </p>
          <ul style={{ color: "#555", paddingLeft: "20px", lineHeight: "1.6" }}>
            <li>Custom API development for businesses</li>
            <li>Seamless third-party integrations</li>
            <li>High-performance, secure, and scalable solutions</li>
          </ul>
        </div>
