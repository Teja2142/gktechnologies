    ...
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px", background: "#f8f9fa" }}>
      ...
      <div style={{ background: "#1a1a2e", padding: "20px", color: "#fff", borderRadius: "8px", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
        ...
        <p style={{ margin: "5px 0 0", fontSize: "14px" }}>
          <span style={{ color: "#f7941d", fontWeight: "bold" }}>HOME</span> &gt; AI SOLUTIONS
        </p>
      </div>
      ...
      <div style={{ display: "flex", marginTop: "20px", gap: "20px" }}>
        ...
        <div style={{ flex: "3", paddingRight: "20px" }}>
          <img src="https://media.freemalaysiatoday.com/wp-content/uploads/2025/02/de2fc860-ai.webp" 
               alt="AI Solutions" 
               style={{ width: "90%", borderRadius: "8px", boxShadow: "0px 4px 8px rgba(0,0,0,0.1)" }} 
          />
          <h2 style={{ marginTop: "20px", color: "#1a1a2e" }}>AI Solutions & Services</h2>
          <p style={{ color: "#555", lineHeight: "1.6" }}>
            At GK Technology, we harness the power of AI to drive business transformation. Our AI solutions enhance efficiency, automate processes, and deliver smarter insights for better decision-making.
          </p>
