    ...
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px", background: "#f8f9fa" }}>
      ...
      <div style={{ background: "#1a1a2e", padding: "20px", color: "#fff", borderRadius: "8px", display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
        ...
        <p style={{ margin: "5px 0 0", fontSize: "14px" }}>
          <span style={{ color: "#f7941d", fontWeight: "bold" }}>HOME</span> &gt; CLOUD SERVICES
        </p>
      </div>
      ...
      <div style={{ display: "flex", marginTop: "20px", gap: "20px" }}>
        ...
        <div style={{ flex: "3", paddingRight: "20px" }}>
          <img src="https://img.freepik.com/premium-photo/cloud-computing-technology-concept_1331575-638.jpg" 
               alt="Cloud Services" 
               style={{ width: "90%", borderRadius: "8px", boxShadow: "0px 4px 8px rgba(0,0,0,0.1)" }} 
          />
          <h2 style={{ marginTop: "20px", color: "#1a1a2e" }}>Cloud Services & Security</h2>
          <p style={{ color: "#555", lineHeight: "1.6" }}>
            At GK Technology, we offer secure and scalable cloud solutions, ensuring businesses can operate efficiently with enhanced security and reliability.
          </p>
          <ul style={{ color: "#555", paddingLeft: "20px", lineHeight: "1.6" }}>
            <li>Cloud infrastructure setup and management</li>
            <li>Secure data storage and backup solutions</li>
            <li>Advanced cybersecurity measures for cloud systems</li>
          </ul>
        </div>
