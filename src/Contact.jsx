  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
      ...
      <div style={{ display: "flex",  flexDirection: "row", gap: "10px", marginBottom: "60px" }}>
        <div style={{ flex: "1 1 100%", Width: "100%", padding: "30px", background: "#f8f9fa", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)" }}>
          ...
          <div style={{ marginBottom: "25px" }}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: "15px" }}>
              ...
              <div>
                <p style={{ margin: "0", fontWeight: "600" }}>GK Technologies</p>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <div><p style={{ margin: "0", fontWeight: "600" }}>hr@kgktechnologies.com</p></div>
            </div>
          </div>
        ...
        <div style={{ flex: "1 1 100%", Width: "100%", padding: "30px", background: "#ffffff", borderRadius: "12px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
      ...
      <div style={{ marginTop: "80px", marginBottom: "60px", textAlign: "center" }}>
        <h2 style={{ color: "#006c94", marginBottom: "40px", fontSize: "1.8rem" }}>Why Choose GK Technologies?</h2>
